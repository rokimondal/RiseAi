            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className={`w-full h-2 rounded-full mt-2 ${getDemandLevelColor(insights.demandLevel)}`}></div>
                    </CardContent>
                </Card>
                    ...
                    <div className="h-[400px]">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={salaryData}>
                                ...
                                />
                                <Bar dataKey="min" fill={themeColors.min} name="Min Salary" />
                                <Bar dataKey="median" fill={themeColors.median} name="Median Salary" />
                                <Bar dataKey="max" fill={themeColors.max} name="Max Salary" />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </CardContent>
                ...
                <Card>
                    ...
                    <CardContent>
                        {insights.recommendedSkills.map((skill, index) => (
                            <Badge key={index} variant="outiline">{skill}</Badge>
                        ))}
                    </CardContent>
                </Card>
            </div>
